...
import { Chain, Ethereum, Polygon, Arbitrum, ArbitrumGoerli, Mumbai, Base, Zora, Blast, BerachainArtio, ZoraSepoliaTestnet, BaseSepoliaTestnet, Scroll } from '@thirdweb-dev/chains'
import { arbitrum, mainnet, polygon, optimism, avalanche, polygonZkEvm, zkSync, linea, zora, base, arbitrumNova, scroll} from 'wagmi/chains'
import { LiveTheLifeTV } from './rollupChains' 
...
export const TW_SUPPORTED_CHAINS = [Ethereum, Polygon, Arbitrum, ArbitrumGoerli, Mumbai, Base, BaseSepoliaTestnet, Zora, Blast, BerachainArtio, ZoraSepoliaTestnet, LiveTheLifeTV, Scroll] as any
